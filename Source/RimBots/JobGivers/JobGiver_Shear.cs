...
namespace RimBots
{
    public class JobGiver_Shear : ThinkNode_JobGiver
    {
        ...
        {
            WorkGiver_Scanner scanner = new WorkGiver_Shear();
            ...
            {
                WorkGiver_Shear shearer = new WorkGiver_Shear();
                return shearer.JobOnThing(pawn, targetInfo.Thing);
            }
            return null;
        }
    }
